  ...
  return (
    <div className="mx-auto max-w-7xl px-5 pb-24 pt-32 sm:px-8 sm:pt-40">
      ...
      {posts.length === 0 ? (
        ...
        <div className="mt-10 grid grid-cols-1 gap-10 sm:mt-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
          {posts.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <h2 className="font-display text-2xl leading-tight tracking-[-0.01em] text-neutral-900">
                  {post.title}
                </h2>
                {post.blurb && (
